...
import os
try:
    from core.ocr_src.pdf_utils import convert_pdf_to_images
    from core.ocr_src.docx_utils import process_docx
except ImportError:
    try:
        from ocr_src.pdf_utils import convert_pdf_to_images
        from ocr_src.docx_utils import process_docx
    except ImportError:
